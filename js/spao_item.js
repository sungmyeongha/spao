const ITEM_LIST = [ 
    [
        {item_no:0, src:``,txt:`[데일리지] 롱 와이드 진(ASH INDIGO)_SPTJEA9G51`,review:'리뷰 864',top:,price:'49900'},
        {item_no:1, src:``,txt:`[UV차단] 라이트 패커블 윈드브레이커(W)_SPJJE25C21`,review:'리뷰 19,425',top2,price:'39900'},
        {item_no:2, src:``,txt:`[고밀도코튼] 오버핏 반팔셔츠_SPYWE24W05`,review:'리뷰 7',top:3,price:'2990'},
        {item_no:3, src:``,txt:`[코튼스판] 셔링 반팔 티셔츠_SPRWE25G17`,review:'리뷰 11',top:4,price:'2500'},
        {item_no:4, src:``,txt:`빈티지 롱 부츠컷 진(BLACK)_SPTJE23G62`,review:'리뷰 18'  ,top:5,price'49900'},
        {item_no:5, src:``,txt:`브레드걸 반팔티_SPRPE24G63`,review:'리뷰 4'  ,top:6,price:'19900'},
       {item_no:6, src:``,txt:`[데일리지] 롱 와이드 진(INDIGO)_SPTJEA9G51`,review:'리뷰 864'  ,top:7,rice:'49900'},
        {item_no:7, src:``,txt:`[소프트코튼] 베이직 하프팬츠_SPMTE24G05`,review:'리뷰 7'  ,top:8,price:'2900'}
    ],
    [
...
function comma(num) {
    ...
    let main_item;
    for (let i = 0; i <8; i++) {
        main_item=`<a href="스파오3페이지.html?cate_no=0&item_no=${ITEM_LIST[0][i].item_no}" class="main_img_box">
        <div class="img_box">
    ...
    $('.item_type').eq(1).click(function(){
        ...
        let main_item;
        for (let i = 0; i <8; i++) {
        main_item=`<a href="스파오3페이지.html?cate_no=1&item_no=${ITEM_LIST[1][i].item_no}" class="main_img_box">
        <div class="img_box">
    ...
    $('.item_type').eq(2).click(function(){
        ...
        let main_item;
        for (let i = 0; i <8; i++) {
        main_item=`<a href="스파오3페이지.html?cate_no=2&item_no=${ITEM_LIST[2][i].item_no}" class="main_img_box">
        <div class="img_box">
    ...
    let page3_item;
    for (let i = 0; i <6; i++) {
        page3_item=`<a href="스파오3페이지.html?cate_no=0&item_no=${ITEM_LIST[0][i].item_no}" class="add_img_box">
        <div class="img_box">
            <img src="${ITEM_LIST[0][i].src}">
        </div>
        <div class="main_txt_box"> 
...
if(cate_no == 3) {
    for (let i = 0; i <24; i++) {
        ...
        let page2_item=`<a href="스파오3페이지.html?cate_no=${cate_no}&item_no=${load_item.item_no}" class="scroll_img_box">
        <div class="img_box">
...
<div class="big_img ">
    ...
    <div class="content_righ_box">
        ...
        <div class="item_buy">
            <div class="chs_color">
                <span class="item_type">color</span>
                <div class="choose_color"> 
                    <div class="choose_color_box">
                        <div class="chs_color_box"  data-color="white">White</div>
                    </div>
                    <div class="choose_color_box">
                        <div class="chs_color_box"  data-color="black">Black</div>
                    </div>
                    <div class="choose_color_box">
                        <div class="chs_color_box"  data-color="mix">Mix</div>
                    </div>
                </div>
                <span class="option color_option">[필수] 옵션을 선택해 주세요</span>
            </div>
